    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    public function createOrganizationOnboardingPortalLinkWithHttpInfo($projectId, $organizationId, $createOrganizationOnboardingPortalLinkBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createOrganizationOnboardingPortalLink'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Ory\Client\Model\OnboardingPortalLink' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ory\Client\Model\OnboardingPortalLink' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Client\Model\OnboardingPortalLink', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    public function getOrganizationOnboardingPortalLinksWithHttpInfo($projectId, $organizationId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getOrganizationOnboardingPortalLinks'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Client\Model\OrganizationOnboardingPortalLinksResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ory\Client\Model\OrganizationOnboardingPortalLinksResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Client\Model\OrganizationOnboardingPortalLinksResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
