...
class ProjectApi
{
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    /**
     * Operation createOrganizationOnboardingPortalLink
     *
     ...
     * @param  \Ory\Client\Model\CreateOrganizationOnboardingPortalLinkBody|null $createOrganizationOnboardingPortalLinkBody createOrganizationOnboardingPortalLinkBody (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createOrganizationOnboardingPortalLink'] to see the possible values for this operation
     *
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\OnboardingPortalLink|\Ory\Client\Model\ErrorGeneric
     */
    public function createOrganizationOnboardingPortalLink($projectId, $organizationId, $createOrganizationOnboardingPortalLinkBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createOrganizationOnboardingPortalLink'][0])
    {
        list($response) = $this->createOrganizationOnboardingPortalLinkWithHttpInfo($projectId, $organizationId, $createOrganizationOnboardingPortalLinkBody, $hostIndex, $variables, $contentType);
        return $response;
    }

    /**
     * Operation createOrganizationOnboardingPortalLinkWithHttpInfo
     *
     * Create organization onboarding portal link
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @param  string $projectId Project ID  The project&#39;s ID. (required)
     * @param  string $organizationId Organization ID  The Organization&#39;s ID. (required)
     * @param  \Ory\Client\Model\CreateOrganizationOnboardingPortalLinkBody|null $createOrganizationOnboardingPortalLinkBody (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createOrganizationOnboardingPortalLink'] to see the possible values for this operation
     *
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\OnboardingPortalLink|\Ory\Client\Model\ErrorGeneric, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOrganizationOnboardingPortalLinkWithHttpInfo($projectId, $organizationId, $createOrganizationOnboardingPortalLinkBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createOrganizationOnboardingPortalLink'][0])
    {
        $request = $this->createOrganizationOnboardingPortalLinkRequest($projectId, $organizationId, $createOrganizationOnboardingPortalLinkBody, $hostIndex, $variables, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\Ory\Client\Model\OnboardingPortalLink',
                        $request,
                        $response,
                    );
                default:
    ...
    /**
     * Operation createOrganizationOnboardingPortalLinkAsync
     *
     * Create organization onboarding portal link
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrganizationOnboardingPortalLinkAsync($projectId, $organizationId, $createOrganizationOnboardingPortalLinkBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createOrganizationOnboardingPortalLink'][0])
    {
        return $this->createOrganizationOnboardingPortalLinkAsyncWithHttpInfo($projectId, $organizationId, $createOrganizationOnboardingPortalLinkBody, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createOrganizationOnboardingPortalLinkAsyncWithHttpInfo
     *
     * Create organization onboarding portal link
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrganizationOnboardingPortalLinkAsyncWithHttpInfo($projectId, $organizationId, $createOrganizationOnboardingPortalLinkBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createOrganizationOnboardingPortalLink'][0])
    {
        $returnType = '\Ory\Client\Model\OnboardingPortalLink';
        $request = $this->createOrganizationOnboardingPortalLinkRequest($projectId, $organizationId, $createOrganizationOnboardingPortalLinkBody, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'createOrganizationOnboardingPortalLink'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://api.console.ory.sh
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createOrganizationOnboardingPortalLinkRequest($projectId, $organizationId, $createOrganizationOnboardingPortalLinkBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createOrganizationOnboardingPortalLink'][0])
    {

        // verify the required parameter 'projectId' is set
        if ($projectId === null || (is_array($projectId) && count($projectId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $projectId when calling createOrganizationOnboardingPortalLink'
            );
        }
        ...
        if ($organizationId === null || (is_array($organizationId) && count($organizationId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organizationId when calling createOrganizationOnboardingPortalLink'
            );
        }



        $resourcePath = '/projects/{project_id}/organizations/{organization_id}/onboarding-portal-links';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($createOrganizationOnboardingPortalLinkBody)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($createOrganizationOnboardingPortalLinkBody));
            } else {
                $httpBody = $createOrganizationOnboardingPortalLinkBody;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
        ...
        $hostSettings = $this->getHostSettingsForcreateOrganizationOnboardingPortalLink();
    ...
    /**
     * Returns an array of host settings for Operation createOrganizationOnboardingPortalLink
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForcreateOrganizationOnboardingPortalLink(): array
    {
        return [
            [
                "url" => "https://api.console.ory.sh",
     ...
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\Project|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\Project|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @param  \Ory\Client\Model\CreateProjectApiKeyBody|null $createProjectApiKeyBody createProjectApiKeyBody (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     */
    public function createProjectApiKey($project, $createProjectApiKeyBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createProjectApiKey'][0])
    {
        list($response) = $this->createProjectApiKeyWithHttpInfo($project, $createProjectApiKeyBody, $hostIndex, $variables, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $project The Project ID or Project slug (required)
     * @param  \Ory\Client\Model\CreateProjectApiKeyBody|null $createProjectApiKeyBody (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createProjectApiKey'] to see the possible values for this operation
     *
     ...
     */
    public function createProjectApiKeyWithHttpInfo($project, $createProjectApiKeyBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createProjectApiKey'][0])
    {
        $request = $this->createProjectApiKeyRequest($project, $createProjectApiKeyBody, $hostIndex, $variables, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createProjectApiKeyAsync($project, $createProjectApiKeyBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createProjectApiKey'][0])
    {
        return $this->createProjectApiKeyAsyncWithHttpInfo($project, $createProjectApiKeyBody, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createProjectApiKeyAsyncWithHttpInfo($project, $createProjectApiKeyBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createProjectApiKey'][0])
    {
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createProjectApiKeyRequest($project, $createProjectApiKeyBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createProjectApiKey'][0])
    {
        ...
        // for model (json/xml)
        if (isset($createProjectApiKeyBody)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($createProjectApiKeyBody));
            } else {
                $httpBody = $createProjectApiKeyBody;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    /**
     * Operation deleteOrganizationOnboardingPortalLink
     *
     ...
     * @param  string $onboardingPortalLinkId onboardingPortalLinkId (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteOrganizationOnboardingPortalLink'] to see the possible values for this operation
     *
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteOrganizationOnboardingPortalLink($projectId, $organizationId, $onboardingPortalLinkId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['deleteOrganizationOnboardingPortalLink'][0])
    {
        $this->deleteOrganizationOnboardingPortalLinkWithHttpInfo($projectId, $organizationId, $onboardingPortalLinkId, $hostIndex, $variables, $contentType);
    }

    /**
     * Operation deleteOrganizationOnboardingPortalLinkWithHttpInfo
     *
     * Delete an organization onboarding portal link
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @param  string $onboardingPortalLinkId (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteOrganizationOnboardingPortalLink'] to see the possible values for this operation
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteOrganizationOnboardingPortalLinkWithHttpInfo($projectId, $organizationId, $onboardingPortalLinkId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['deleteOrganizationOnboardingPortalLink'][0])
    {
        $request = $this->deleteOrganizationOnboardingPortalLinkRequest($projectId, $organizationId, $onboardingPortalLinkId, $hostIndex, $variables, $contentType);
    ...
    /**
     * Operation deleteOrganizationOnboardingPortalLinkAsync
     *
     * Delete an organization onboarding portal link
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteOrganizationOnboardingPortalLinkAsync($projectId, $organizationId, $onboardingPortalLinkId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['deleteOrganizationOnboardingPortalLink'][0])
    {
        return $this->deleteOrganizationOnboardingPortalLinkAsyncWithHttpInfo($projectId, $organizationId, $onboardingPortalLinkId, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteOrganizationOnboardingPortalLinkAsyncWithHttpInfo
     *
     * Delete an organization onboarding portal link
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteOrganizationOnboardingPortalLinkAsyncWithHttpInfo($projectId, $organizationId, $onboardingPortalLinkId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['deleteOrganizationOnboardingPortalLink'][0])
    {
        $returnType = '';
        $request = $this->deleteOrganizationOnboardingPortalLinkRequest($projectId, $organizationId, $onboardingPortalLinkId, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'deleteOrganizationOnboardingPortalLink'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://api.console.ory.sh
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteOrganizationOnboardingPortalLinkRequest($projectId, $organizationId, $onboardingPortalLinkId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['deleteOrganizationOnboardingPortalLink'][0])
    {

        // verify the required parameter 'projectId' is set
        if ($projectId === null || (is_array($projectId) && count($projectId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $projectId when calling deleteOrganizationOnboardingPortalLink'
            );
        }
        ...
        if ($organizationId === null || (is_array($organizationId) && count($organizationId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organizationId when calling deleteOrganizationOnboardingPortalLink'
            );
        }

        // verify the required parameter 'onboardingPortalLinkId' is set
        if ($onboardingPortalLinkId === null || (is_array($onboardingPortalLinkId) && count($onboardingPortalLinkId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $onboardingPortalLinkId when calling deleteOrganizationOnboardingPortalLink'
            );
        }


        $resourcePath = '/projects/{project_id}/organizations/{organization_id}/onboarding-portal-links/{onboarding_portal_link_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($onboardingPortalLinkId !== null) {
            $resourcePath = str_replace(
                ...
                ObjectSerializer::toPathValue($onboardingPortalLinkId),
                $resourcePath
            );
        }
        ...
        $hostSettings = $this->getHostSettingsFordeleteOrganizationOnboardingPortalLink();
    ...
    /**
     * Returns an array of host settings for Operation deleteOrganizationOnboardingPortalLink
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsFordeleteOrganizationOnboardingPortalLink(): array
    {
        return [
            [
                "url" => "https://api.console.ory.sh",
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\GetOrganizationResponse|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\GetOrganizationResponse|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    /**
     * Operation getOrganizationOnboardingPortalLinks
     *
     ...
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOrganizationOnboardingPortalLinks'] to see the possible values for this operation
     *
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\OrganizationOnboardingPortalLinksResponse|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric
     */
    public function getOrganizationOnboardingPortalLinks($projectId, $organizationId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getOrganizationOnboardingPortalLinks'][0])
    {
        list($response) = $this->getOrganizationOnboardingPortalLinksWithHttpInfo($projectId, $organizationId, $hostIndex, $variables, $contentType);
        return $response;
    }

    /**
     * Operation getOrganizationOnboardingPortalLinksWithHttpInfo
     *
     * Get the organization onboarding portal links
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\OrganizationOnboardingPortalLinksResponse|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrganizationOnboardingPortalLinksWithHttpInfo($projectId, $organizationId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getOrganizationOnboardingPortalLinks'][0])
    {
        $request = $this->getOrganizationOnboardingPortalLinksRequest($projectId, $organizationId, $hostIndex, $variables, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Ory\Client\Model\OrganizationOnboardingPortalLinksResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation getOrganizationOnboardingPortalLinksAsync
     *
     * Get the organization onboarding portal links
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationOnboardingPortalLinksAsync($projectId, $organizationId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getOrganizationOnboardingPortalLinks'][0])
    {
        return $this->getOrganizationOnboardingPortalLinksAsyncWithHttpInfo($projectId, $organizationId, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrganizationOnboardingPortalLinksAsyncWithHttpInfo
     *
     * Get the organization onboarding portal links
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationOnboardingPortalLinksAsyncWithHttpInfo($projectId, $organizationId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getOrganizationOnboardingPortalLinks'][0])
    {
        $returnType = '\Ory\Client\Model\OrganizationOnboardingPortalLinksResponse';
        $request = $this->getOrganizationOnboardingPortalLinksRequest($projectId, $organizationId, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'getOrganizationOnboardingPortalLinks'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://api.console.ory.sh
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrganizationOnboardingPortalLinksRequest($projectId, $organizationId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['getOrganizationOnboardingPortalLinks'][0])
    {

        // verify the required parameter 'projectId' is set
        if ($projectId === null || (is_array($projectId) && count($projectId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $projectId when calling getOrganizationOnboardingPortalLinks'
            );
        }
        ...
        if ($organizationId === null || (is_array($organizationId) && count($organizationId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organizationId when calling getOrganizationOnboardingPortalLinks'
            );
        }
        ...
        $hostSettings = $this->getHostSettingsForgetOrganizationOnboardingPortalLinks();
    ...
    /**
     * Returns an array of host settings for Operation getOrganizationOnboardingPortalLinks
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForgetOrganizationOnboardingPortalLinks(): array
    {
        return [
            [
                "url" => "https://api.console.ory.sh",
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\SuccessfulProjectUpdate|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\SuccessfulProjectUpdate|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    /**
     * Operation updateOrganizationOnboardingPortalLink
     *
     ...
     * @param  string $organizationId Organization ID  The Organization&#39;s ID. (required)
     * @param  string $onboardingPortalLinkId onboardingPortalLinkId (required)
     * @param  \Ory\Client\Model\UpdateOrganizationOnboardingPortalLinkBody|null $updateOrganizationOnboardingPortalLinkBody updateOrganizationOnboardingPortalLinkBody (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateOrganizationOnboardingPortalLink'] to see the possible values for this operation
     *
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\OnboardingPortalLink|\Ory\Client\Model\ErrorGeneric
     */
    public function updateOrganizationOnboardingPortalLink($projectId, $organizationId, $onboardingPortalLinkId, $updateOrganizationOnboardingPortalLinkBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['updateOrganizationOnboardingPortalLink'][0])
    {
        list($response) = $this->updateOrganizationOnboardingPortalLinkWithHttpInfo($projectId, $organizationId, $onboardingPortalLinkId, $updateOrganizationOnboardingPortalLinkBody, $hostIndex, $variables, $contentType);
        return $response;
    }

    /**
     * Operation updateOrganizationOnboardingPortalLinkWithHttpInfo
     *
     * Update organization onboarding portal link
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @param  string $organizationId Organization ID  The Organization&#39;s ID. (required)
     * @param  string $onboardingPortalLinkId (required)
     * @param  \Ory\Client\Model\UpdateOrganizationOnboardingPortalLinkBody|null $updateOrganizationOnboardingPortalLinkBody (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateOrganizationOnboardingPortalLink'] to see the possible values for this operation
     *
     ...
     * @return array of \Ory\Client\Model\OnboardingPortalLink|\Ory\Client\Model\ErrorGeneric, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateOrganizationOnboardingPortalLinkWithHttpInfo($projectId, $organizationId, $onboardingPortalLinkId, $updateOrganizationOnboardingPortalLinkBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['updateOrganizationOnboardingPortalLink'][0])
    {
        $request = $this->updateOrganizationOnboardingPortalLinkRequest($projectId, $organizationId, $onboardingPortalLinkId, $updateOrganizationOnboardingPortalLinkBody, $hostIndex, $variables, $contentType);
    ...
    /**
     * Operation updateOrganizationOnboardingPortalLinkAsync
     *
     * Update organization onboarding portal link
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOrganizationOnboardingPortalLinkAsync($projectId, $organizationId, $onboardingPortalLinkId, $updateOrganizationOnboardingPortalLinkBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['updateOrganizationOnboardingPortalLink'][0])
    {
        return $this->updateOrganizationOnboardingPortalLinkAsyncWithHttpInfo($projectId, $organizationId, $onboardingPortalLinkId, $updateOrganizationOnboardingPortalLinkBody, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateOrganizationOnboardingPortalLinkAsyncWithHttpInfo
     *
     * Update organization onboarding portal link
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOrganizationOnboardingPortalLinkAsyncWithHttpInfo($projectId, $organizationId, $onboardingPortalLinkId, $updateOrganizationOnboardingPortalLinkBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['updateOrganizationOnboardingPortalLink'][0])
    {
        $returnType = '\Ory\Client\Model\OnboardingPortalLink';
        $request = $this->updateOrganizationOnboardingPortalLinkRequest($projectId, $organizationId, $onboardingPortalLinkId, $updateOrganizationOnboardingPortalLinkBody, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'updateOrganizationOnboardingPortalLink'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://api.console.ory.sh
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateOrganizationOnboardingPortalLinkRequest($projectId, $organizationId, $onboardingPortalLinkId, $updateOrganizationOnboardingPortalLinkBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['updateOrganizationOnboardingPortalLink'][0])
    {

        // verify the required parameter 'projectId' is set
        if ($projectId === null || (is_array($projectId) && count($projectId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $projectId when calling updateOrganizationOnboardingPortalLink'
            );
        }
        ...
        if ($organizationId === null || (is_array($organizationId) && count($organizationId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organizationId when calling updateOrganizationOnboardingPortalLink'
            );
        }
        ...
        if ($onboardingPortalLinkId === null || (is_array($onboardingPortalLinkId) && count($onboardingPortalLinkId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $onboardingPortalLinkId when calling updateOrganizationOnboardingPortalLink'
            );
        }
        ...
        // for model (json/xml)
        if (isset($updateOrganizationOnboardingPortalLinkBody)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($updateOrganizationOnboardingPortalLinkBody));
            } else {
                $httpBody = $updateOrganizationOnboardingPortalLinkBody;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
        ...
        $hostSettings = $this->getHostSettingsForupdateOrganizationOnboardingPortalLink();
    ...
    /**
     * Returns an array of host settings for Operation updateOrganizationOnboardingPortalLink
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForupdateOrganizationOnboardingPortalLink(): array
    {
        return [
            [
                "url" => "https://api.console.ory.sh",
