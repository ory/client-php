...
class ProjectApi
{
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
    ...
    public function createOrganizationRequest($projectId, $organizationBody = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['createOrganization'][0])
    {
        ...
        $apiKey = $this->config->getApiKeyWithPrefix('ory_session_ory');
        if ($apiKey !== null) {
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     */
    public function listOrganizations($projectId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['listOrganizations'][0])
    {
        list($response) = $this->listOrganizationsWithHttpInfo($projectId, $hostIndex, $variables, $contentType);
        return $response;
    }
     ...
     */
    public function listOrganizationsWithHttpInfo($projectId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['listOrganizations'][0])
    {
        $request = $this->listOrganizationsRequest($projectId, $hostIndex, $variables, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listOrganizationsAsync($projectId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['listOrganizations'][0])
    {
        return $this->listOrganizationsAsyncWithHttpInfo($projectId, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listOrganizationsAsyncWithHttpInfo($projectId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['listOrganizations'][0])
    {
        $returnType = '\Ory\Client\Model\ListOrganizationsResponse';
        $request = $this->listOrganizationsRequest($projectId, $hostIndex, $variables, $contentType);
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listOrganizationsRequest($projectId, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['listOrganizations'][0])
    {
