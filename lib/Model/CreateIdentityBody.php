...
class CreateIdentityBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets region
     *
     * @param string|null $region Region is the Ory Network region this identity will be created in. Optional; defaults to the project home region if omitted. Only effective on the Ory Network. eu-central EUCentral asia-northeast AsiaNorthEast us-east USEast us-west USWest eu EU asia Asia us US global Global
     *
     * @return self
     */
