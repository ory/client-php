...
/**
 * UpdateLoginFlowWithDeviceAuthnMethod Class Doc Comment
 *
 * @category Class
 * @description Log in by proving possession of an enrolled device key. The device signs the challenge nonce found in the login flow&#39;s hidden &#x60;deviceauthn_nonce&#x60; UI node; a PIN-protected key additionally proves knowledge of the PIN via &#x60;pin_proof&#x60;.  Use it for step-up in a login flow created with &#x60;aal&#x3D;aal2&#x60;, or as the sole first factor (a one-step AAL2 login, for keys with \&quot;pin\&quot; or \&quot;platform\&quot; user verification) when the project&#39;s deviceauthn first_factor setting is enabled. Only API (native) flows support this method.
 * @package  Ory\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateLoginFlowWithDeviceAuthnMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateLoginFlowWithDeviceAuthnMethod';
    ...
    */
     ...
     * Sets method
     *
     * @param string $method Method should be set to \"deviceauthn\" when logging in using the DeviceAuthn strategy.
     *
     * @return self
     */
