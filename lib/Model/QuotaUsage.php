...
class QuotaUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const FEATURE_REGION_EU = 'region_eu';
    public const FEATURE_REGION_US = 'region_us';
    public const FEATURE_REGION_APAC = 'region_apac';
    public const FEATURE_REGION_GLOBAL = 'region_global';
