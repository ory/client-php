...
class QuotaUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const FEATURE_EVENT_STREAMS = 'event_streams';
    ...
    const FEATURE_PROJECT_METRICS_EVENTS_HISTORY = 'project_metrics_events_history';
    const FEATURE_ORGANIZATIONS = 'organizations';
    const FEATURE_ROP_GRANT = 'rop_grant';
    const FEATURE_CONCIERGE_ONBOARDING = 'concierge_onboarding';
    ...
    const FEATURE_PERMISSION_CHECKS_RATE_LIMIT_TIER = 'permission_checks_rate_limit_tier';
    const FEATURE_OAUTH2_INTROSPECT_RATE_LIMIT_TIER = 'oauth2_introspect_rate_limit_tier';
