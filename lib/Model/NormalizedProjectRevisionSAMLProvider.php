...
class NormalizedProjectRevisionSAMLProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'audienceOverrideBaseUrl' => 'string',
        'createdAt' => '\DateTime',
        'id' => 'string',
        'label' => 'string',
        'mapperUrl' => 'string',
    ...
    protected static array $openAPINullables = [
        ...
        'providerId' => false,
        'proxyAcsUrl' => true,
        'proxySamlAudienceOverride' => true,
    ...
    protected static $attributeMap = [
        'audienceOverrideBaseUrl' => 'audience_override_base_url',
    ...
    protected static $setters = [
        'audienceOverrideBaseUrl' => 'setAudienceOverrideBaseUrl',
    ...
    protected static $getters = [
        'audienceOverrideBaseUrl' => 'getAudienceOverrideBaseUrl',
    ...
    {
        $this->setIfExists('audienceOverrideBaseUrl', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets audienceOverrideBaseUrl
     *
     * @return string|null
     */
    public function getAudienceOverrideBaseUrl()
    {
        return $this->container['audienceOverrideBaseUrl'];
    }

    /**
     * Sets audienceOverrideBaseUrl
     *
     * @param string|null $audienceOverrideBaseUrl audienceOverrideBaseUrl
     *
     * @return self
     */
    public function setAudienceOverrideBaseUrl($audienceOverrideBaseUrl)
    {
        if (is_null($audienceOverrideBaseUrl)) {
            array_push($this->openAPINullablesSetToNull, 'audienceOverrideBaseUrl');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('audienceOverrideBaseUrl', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['audienceOverrideBaseUrl'] = $audienceOverrideBaseUrl;
     ...
     * Sets proxyAcsUrl
     *
     * @param string|null $proxyAcsUrl proxyAcsUrl
     *
     * @return self
     */
    public function setProxyAcsUrl($proxyAcsUrl)
    {
        if (is_null($proxyAcsUrl)) {
            array_push($this->openAPINullablesSetToNull, 'proxyAcsUrl');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('proxyAcsUrl', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $proxySamlAudienceOverride proxySamlAudienceOverride
     *
     * @return self
     */
    public function setProxySamlAudienceOverride($proxySamlAudienceOverride)
    {
        if (is_null($proxySamlAudienceOverride)) {
            array_push($this->openAPINullablesSetToNull, 'proxySamlAudienceOverride');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('proxySamlAudienceOverride', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets validTo
     *
     * @param string[]|null $validTo Valid to dates of all signing certs associated with the SAML connection
     *
     * @return self
     */
