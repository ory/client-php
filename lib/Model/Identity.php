 ...
 *
 * @category Class
 * @description An [identity](https://www.ory.com/docs/kratos/concepts/identity-user-model) represents a (human) user in Ory.
 * @package  Ory\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Identity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const REGION_EU_CENTRAL = 'eu-central';
    public const REGION_ASIA_NORTHEAST = 'asia-northeast';
    ...
    public const REGION__GLOBAL = 'global';
    public const REGION_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getRegionAllowableValues()
    {
        return [
            ...
            self::REGION_US,
            self::REGION__GLOBAL,
            self::REGION_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    */
     ...
     * Sets region
     *
     * @param string|null $region Region is the Ory Network region this identity is homed in. Set by the multi-region persister; empty on OSS and single-region deployments. eu-central EUCentral asia-northeast AsiaNorthEast us-east USEast us-west USWest eu EU asia Asia us US global Global
     *
     * @return self
     */
    public function setRegion($region)
    {
        ...
        if (!in_array($region, $allowedValues, true)) {
            $region = self::REGION_UNKNOWN_DEFAULT_OPEN_API;
        }
